...
from Model import process_json_data
...
if uploaded_file:
    ...
    if layout_data:
        ...
        # Your existing report metadata & visuals analysis code here,

        # just replace layout_data loading from file to using this layout_data variable
